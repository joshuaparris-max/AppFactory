...
export const FILE_OWNERSHIP_SUGGESTIONS = {
  foundation: ['package.json', 'tsconfig.json', 'lib/**', 'src/core/**', 'docs/architecture/**'],
  uiUx: ['app/**', 'pages/**', 'src/app/**', 'src/components/**', 'src/styles/**', 'public/**'],
  backend: ['src/api/**', 'src/server/**', 'src/services/**', 'src/db/**', 'lib/services/**'],
  qaDocs: ['tests/**', 'e2e/**', 'docs/**', 'README.md', 'playwright.config.*'],
} as const;
